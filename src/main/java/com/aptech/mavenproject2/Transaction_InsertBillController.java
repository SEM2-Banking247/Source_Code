 ...
 * @author tuan
 */
public class Transaction_InsertBillController implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        switch (transaction_type_id) {
            ...
            case 2:{
                ...
                txtCardNumberRequest.setText(custom_Transaction.getAcc_number_request());
                txtBankRequest.setText("Ecombank");
                txtDescription.setText("Nap tien tai quay vao ngay "+custom_Transaction.getTransaction_date());
                txtTransactionId.setText(Integer.toString(custom_Transaction.getTransaction_id()));
                break;
            }
            ...
            case 3: {
                ...
                try {
                    ...
                    Logger.getLogger(Transaction_InsertBillController.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void printBill() throws FileNotFoundException, IOException{
        try (PDDocument pdfdoc = new PDDocument()) {
            ...
            try (PDPageContentStream contentStream = new PDPageContentStream(pdfdoc, page)) {
                ...
                //add acc receiver number
                contentStream.beginText();
                contentStream.newLineAtOffset(30, 370);
                String accReceiverNumber = custom_Transaction.getAcc_number_receiver();
                contentStream.showText(accReceiverNumber);
                contentStream.endText();
                ...
                String description = "Giao dich tai quay ngay "+custom_Transaction.getTransaction_date();
