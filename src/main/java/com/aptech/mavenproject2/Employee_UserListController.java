 ...
 * @author Admin
 */
public class Employee_UserListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(Employee_UserListController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
    ...
    public void showAccounts() throws SQLException {
        ArrayList<User> data = userEntity.selectAllCustomers();
